...
IF(SDL3_LIBRARY_TEMP)
  ...
  # For OS X, SDL3 uses Carbon, Cocoa, CoreAudio, AudioUnit, ForceFeedback,
  ...
  # the "real" variable in one-shot.
	IF(APPLE)
    SET(SDL3_LIBRARY_TEMP ${SDL3_LIBRARY_TEMP} "-framework Carbon -framework Cocoa -framework CoreAudio -framework AudioUnit -framework AudioToolbox -framework ForceFeedback -framework IOKit -framework CoreVideo -liconv")
	ENDIF(APPLE)
